/*  
 *   Play pong on an 8x8 matrix - project from itopen.it, modified by gtomco - mrtechie.site
 */
...
#define PADSIZE 3
#define BALL_DELAY 180 // 200 is normal
#define GAME_DELAY 10
#define SPR_DELAY 1000
#define BOUNCE_VERTICAL 1
#define BOUNCE_HORIZONTAL -1
#define NEW_GAME_ANIMATION_SPEED 30
#define HIT_NONE 0
#define HIT_CENTER 1
#define HIT_LEFT 2
#define HIT_RIGHT 3
...
byte emotions[][8] = {
  { B00000000, B01000100, B00010000, B00010000, B00000000, B00111000, B01000100, B00000000 }, // SAD
  { B00000000, B01000100, B00010000, B00010000, B00010000, B01000100, B00111000, B00000000 }  // SMILEY
};
...
void setup() {
  ...
  lc.shutdown(0,false);  // The MAX72XX is on standby at start, wake it up
